  ...
  return (
    <nav className={styles.Navbar}>
      <div className={styles.Navbar__wrapper}>
        <div className='p-4'>
          <Logo size={140} className='fill-orange-500' />
        </div>
        <div className='flex items-center'>
          <NavbarItem>
            <CrownIcon size={24} className="fill-yellow-400" />
          </NavbarItem>
          <NavbarItem>
            <SearchIcon size={24} className="fill-white" />
          </NavbarItem>
          <NavbarItem className='gap-2 px-4'>
            <div className='rounded-full bg-gradient-to-br from-orange-200 to-orange-500 w-8 h-8' />
            <TriangleIcon size={24} className="fill-white" />
          </NavbarItem>
        </div>
      </div>
    </nav>
